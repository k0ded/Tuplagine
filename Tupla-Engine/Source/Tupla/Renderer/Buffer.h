...
namespace Tupla
{
    ...
    public:
        ...
        template <typename T>
        bool WriteToBuffer(const T& aType, u64 offset = 0)
        {
            return WriteToBuffer(&aType, sizeof(T), offset);
        }
    ...
    protected:
        virtual bool WriteToBuffer(const void* data, u64 size, u64 offset = 0) = 0;
